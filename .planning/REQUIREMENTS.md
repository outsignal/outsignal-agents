...
- [x] **API-01**: EmailBison sendReply endpoint validated via live spike test
- [x] **API-02**: EmailBison client extended with sendReply(), getReply(), getRepliesPage() methods
...
- [x] **NAV-01**: Portal sidebar replaces "Replies" with "Inbox"
- [x] **NAV-02**: Admin sidebar adds "Inbox" nav item
