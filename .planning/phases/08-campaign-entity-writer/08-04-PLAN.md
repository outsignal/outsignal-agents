...
must_haves:
  ...
  key_links:
    - from: "src/lib/agents/writer.ts"
      ...
      via: "searchKnowledge for auto-searching best practices (via shared tool from 08-02)"
      pattern: "searchKnowledge"
    - from: "src/lib/agents/writer.ts"
      to: "src/lib/campaigns/operations.ts"
      via: "getCampaign for loading campaign context (from 08-03)"
      pattern: "getCampaign"
---
...
<!-- Campaign operations from Plan 03 (available as dependency) -->
...
<!-- Shared tool from Plan 02 (available as dependency) -->
