  ...
  const groups: CommandGroup[] = [
    {
      ...
      items: [
        ...
        { id: "workspaces", label: "Workspaces", icon: Building2, onSelect: () => navigate("/workspaces") },
        ...
        { id: "search", label: "Search", icon: Search, onSelect: () => navigate("/search") },
        { id: "financials", label: "Financials", icon: FileText, onSelect: () => navigate("/financials") },
        { id: "tasks", label: "Tasks", icon: CheckSquare, onSelect: () => navigate("/tasks") },
        { id: "sales", label: "Sales", icon: FileSignature, onSelect: () => navigate("/sales") },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "onboarding", label: "Onboarding", icon: UserPlus, onSelect: () => navigate("/sales") },
    ...
    },
    {
      heading: "Settings",
      items: [
        { id: "operations", label: "Operations", icon: Settings, onSelect: () => navigate("/settings?tab=operations") },
        { id: "integrations", label: "Integrations", icon: Settings, onSelect: () => navigate("/settings?tab=integrations") },
        { id: "notifications", label: "Notifications", icon: Settings, onSelect: () => navigate("/settings?tab=notifications") },
        { id: "costs", label: "Enrichment Costs", icon: Settings, onSelect: () => navigate("/settings?tab=costs") },
        { id: "packages", label: "Packages", icon: Settings, onSelect: () => navigate("/settings?tab=packages") },
        { id: "content", label: "Content / Pages", icon: Settings, onSelect: () => navigate("/settings?tab=content") },
        { id: "guide", label: "Agent Guide", icon: Settings, onSelect: () => navigate("/settings?tab=guide") },
        { id: "support", label: "Support", icon: Settings, onSelect: () => navigate("/support") },
      ],
    },
    {
      heading: "Actions",
      items: [
        ...
        { id: "sync-replies", label: "Sync Replies", icon: RefreshCw, onSelect: () => navigate("/inbox?view=classifications&sync=1") },
