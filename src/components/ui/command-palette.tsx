  ...
  const groups: CommandGroup[] = [
    {
      ...
      items: [
        ...
        { id: "senders", label: "Senders", icon: Send, onSelect: () => navigate("/deliverability?tab=senders") },
        ...
        { id: "onboard", label: "Onboard", icon: ClipboardList, onSelect: () => navigate("/clients?tab=onboard") },
