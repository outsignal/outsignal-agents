---
name: nova-leads
description: Outsignal lead discovery agent. Finds, scores, and manages target lists of prospects. Use when discovering leads, building lists, scoring against ICP, or exporting to EmailBison.
---
